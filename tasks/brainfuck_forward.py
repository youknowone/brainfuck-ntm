...
def run(ntm, seq_length, sess, idx=None, print_=True):
    return common.meta_run(ntm, seq_length, sess, generate_training_sequence=generate_training_sequence, forward_only=True, idx=idx, pprint_out=pprint_out, print_=print_)


def train(ntm, config, sess):
    return common.meta_train(ntm, config, sess, generate_training_sequence=generate_training_sequence, forward_only=True)
